...
foreach($fields as $field => $attr)
{
    ...
    if(($field == 'rocketXAuthToken' || $field == 'rocketXUserId') && $webhook->type != 'rocketchannel') continue;
    ...
    if($field == 'rocketChannel') $default = $webhook->params;
    if($field == 'rocketXAuthToken') $default = $secret->appSecret;
    if($field == 'rocketXUserId') $default = $secret->appId;

    if($field == 'rocketXAuthToken' || $field == 'rocketXUserId')  $rowClass = 'rocketTR';
