...
$config->webhook->form->create['rocketXAuthToken'] = array('type' => 'string', 'control' => 'text',      'required' => false, 'default' => '', 'filter'  => 'trim');
$config->webhook->form->create['rocketXUserId']    = array('type' => 'string', 'control' => 'text',      'required' => false, 'default' => '', 'filter'  => 'trim');
...
$config->webhook->form->edit['rocketXAuthToken'] = array('type' => 'string', 'control' => 'text',      'required' => false, 'default' => '', 'filter'  => 'trim');
$config->webhook->form->edit['rocketXUserId']    = array('type' => 'string', 'control' => 'text',      'required' => false, 'default' => '', 'filter'  => 'trim');
