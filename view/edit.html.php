  ...
  <div class='center-block'>
    ...
    <form id='webhookForm' method='post' class='form-ajax'>
      <table class='table table-form'>
        ...
        <tr class="rocketTR">
          <th><?php echo $lang->webhook->rocketXAuthToken;?></th>
          <td><?php echo html::input('rocketXAuthToken', $secret->appSecret, "class='form-control'")?></td>
          <td></td>
        </tr>
        <tr class="rocketTR">
          <th><?php echo $lang->webhook->rocketXUserId;?></th>
          <td><?php echo html::input('rocketXUserId', $secret->appId, "class='form-control'")?></td>
          <td></td>
        </tr>
        <?php endif;?>
        <tr>
